...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private float[] mAccelorometerData = new float[3];
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        switch (sensorType){
            case Sensor.TYPE_ACCELEROMETER:
                mAccelorometerData = sensorEvent.values.clone();
                break;
        ...
        SensorManager.getRotationMatrix(rotationMatrix, null, mAccelorometerData, mMagnetometerData);
